...
import {year2CseBatch1Array, year2ItBatch1Array, year2EtcBatch1Array, year2EiBatch1Array,
  ...
  return(
    ...
    <div>
      {(name1 == "cse" && name2 == "batch1")?
        ...
        <DisplayGrid2 array={year2CivilBatch2Array} b6Id="active2" branch="civil" year={2} batch="batch2" b2_2Id="active2"/>
